...
public class RootFileChooserDialog extends DialogFragment implements MaterialDialog.ListCallback {
    ...
    public void onAttach(Activity activity) {
        ...
        mCallback = (FileCallback) fragment;
    }
    ...
    public static class Builder implements Serializable {
        ...
        @NonNull
        public RootFileChooserDialog build() {
            RootFileChooserDialog dialog = new RootFileChooserDialog();
        ...
        @NonNull
        public RootFileChooserDialog show() {
            RootFileChooserDialog dialog = build();
